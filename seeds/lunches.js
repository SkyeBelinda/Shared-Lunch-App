      ...
      return knex('table_name').insert([
        {
          id: 1,
          Name: 'Mexican', 
          description: 'For a tasty meal that will satisfy the whole team, whip up a plate of these delicious Mexican Nachos. Juicy tomatoes, onions and jalapeños with Mexican-inspired herbs. They will not disappoint!', ingredients: 


		  	{type: '300 g lean beef mince'}, 
		  	'1 medium onion, diced', 
		  	'375 g pouch Watties Mexican Creations Nachos Simmer Sauce', 
		  	'400 g can Watties Red Kidney Beans in Springwater, drained', 
        ...
        {id: 2, Name: 'Vegetarian', description: '', ingredients: '', image: ''},
        {id: 3, Name: 'The Classic', description: '', ingredients: '', image: ''}
      ]);
    });
};
...
id: 1,
    ...
    id: 2,
		...
		ingredients: [
			...
			'Chilli powder to taste', '4 tablespoons tomato purée', 
			'250g cauliflower florets', 
			'green capsicum, cored, deseeded and cubed', 
